  ...
  render() {
    return (
      <div className='page-box2'>
        ...
        <span className='match' id='A'>A</span>
        <div>
          <div className='img-box2'></div>
          <div className='text-box2'>
        ...
        <MatchWrapper>
          <Match href='#top'>↑</Match>
          <Match>◇</Match>
          <Match href='#A'>A</Match>
          <Match href='#B'>B</Match>
          <Match href='#C'>C</Match>
          <Match href='#D'>D</Match>
          <Match href='#E'>E</Match>
          <Match href='#F'>F</Match>
          <Match href='#G'>G</Match>
          <Match href='#H'>H</Match>
          <Match href='#I'>I</Match>
          <Match href='#J'>J</Match>
          <Match href='#K'>K</Match>
          <Match href='#L'>L</Match>
          <Match href='#M'>M</Match>
          <Match href='#N'>N</Match>
          <Match href='#O'>O</Match>
          <Match href='#P'>P</Match>
          <Match href='#Q'>Q</Match>
          <Match href='#R'>R</Match>
          <Match href='#S'>S</Match>
          <Match href='#T'>T</Match>
          <Match href='#U'>U</Match>
          <Match href='#V'>V</Match>
          <Match href='#W'>W</Match>
          <Match href='#X'>X</Match>
          <Match href='#Y'>Y</Match>
          <Match href='#Z'>Z</Match>
          <Match href='#diff'>#</Match>
        </MatchWrapper>
      </div>
    )
  }
